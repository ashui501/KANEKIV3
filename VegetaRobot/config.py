...
class Config(object):
    ...
    TOKEN = "7281123784:AAGIuyyQQ88S3KamTIBxtDen-N_jh1uRA7s"  #This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    ...
    INFOPIC = True
    URL = None
    SPAMWATCH_API = "OIPDXsKAiyKe2iznM6bKLSFZLWMmS0fb3YdDyThssouwjsCRBgYo_oikSadSYX3D"  # go to support.spamwat.ch to get key -
